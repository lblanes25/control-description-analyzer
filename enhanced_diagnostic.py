...
def main():
    ...
    check_file_exists("config_manager.py")
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location("config_manager", "config_manager.py")
        config_module = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(config_module)
        print("✓ Imported config_manager")

        # Inspect ConfigManager
        config_manager_class = config_module.ConfigManager
        ...
        print(f"✗ Error with config_manager: {e}")
        traceback.print_exc()
